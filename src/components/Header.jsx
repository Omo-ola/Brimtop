...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between px-6 md:px-4 py-4 ">
      ...
      <div
        className="fixed w-[60%] bg-white shadow-lg md:shadow-none top-0 right-0 z-20 px-8 h-screen md:flex justify-between gap-8 transition-all duration-100 translate-x-[50rem] md:translate-x-0"
        ref={list}
      >
        <ul className="mt-20 md:mt-0 md:flex items-center justify-between gap-3 text-sm font-semibold">
          <li>
            <Link className="my-4" to='/'>Home</Link>
          </li>
          <li>
            {" "}
            <Link className="my-4">All Books</Link>
          </li>
          <li>
            <Link className="my-4">My Books</Link>
          </li>
          <li>
            <Link className="my-4">Contact Us</Link>
          </li>
        </ul>
        <div className="md:flex items-center justify-between text-sm gap-3">
          <Link
            to="/login"
            href="#"
            className="block md:inline-block p-1.5 border border-blue-600 text-blue-600 rounded-sm text-center  mt-4 mb-4 md:mb-0 md:mt-0"
          >
            Login
          </Link>
          <Link
        ...
        <svg
          className="absolute top-3 right-7 md:hidden"
          onClick={handleClose}
          xmlns="http://www.w3.org/2000/svg"
          height="2em"
          viewBox="0 0 384 512"
